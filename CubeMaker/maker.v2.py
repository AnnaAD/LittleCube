...
class Controller:
    ...
    def __init__(self, outDir):
        ...
        self.j1 = Button(self.root, text='Generate', command=LevelGenerate, width=51)
    ...
    def LevelGenerate(self):
        ...
        process = subprocess.Popen('./generate.csh %s > levels.js' % self.outDir, shell=True, stdout=subprocess.PIPE)
        process.wait()
